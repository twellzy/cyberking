...
#check for system user expiry dates
#echo "image will refresh at the end, so don't freak out"
sleep 5
...
echo "Did you change your password??? Do you want to do PAM?? (y/n)"
read fquestion
if [ $fquestion == "y" ] || [ $fquestion == "Y" ];
then
...
#maybe look into mcafeetp pkg and ENSTLP config
